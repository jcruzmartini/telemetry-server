...
public class MonitoringStationCreditCheckerTaskTest {

    private static Injector injector;
    private MonitoringStationCreditCheckerTask task;
    ...
    public void setUp() throws Exception {
        task = injector.getInstance(MonitoringStationCreditCheckerTask.class);
    }
